...
output "atlantis_ssh_public_key" {
  ...
  value       = module.atlantis.atlantis_ssh_public_key
}
...
output "atlantis_webhook_url" {
  ...
  value       = module.atlantis.atlantis_webhook_url
}
...
output "ecr_registry_id" {
  value       = module.atlantis.ecr_registry_id
...
output "alb_ingress_target_group_name" {
  ...
  value       = module.atlantis.alb_ingress_target_group_name
}

output "alb_ingress_target_group_arn" {
  description = "ALB Target Group ARN"
  value       = module.atlantis.alb_ingress_target_group_arn
}

output "alb_ingress_target_group_arn_suffix" {
  description = "ALB Target Group ARN suffix"
  value       = module.atlantis.alb_ingress_target_group_arn_suffix
}
...
output "container_definition_json" {
  ...
  value       = module.atlantis.container_definition_json
}

output "container_definition_json_map" {
  description = "JSON encoded container definitions for use with other terraform resources such as aws_ecs_task_definition"
  value       = module.atlantis.container_definition_json_map
}

output "ecs_exec_role_policy_id" {
  description = "The ECS service role policy ID, in the form of `role_name:role_policy_name`"
  value       = module.atlantis.ecs_exec_role_policy_id
}

output "ecs_exec_role_policy_name" {
  description = "ECS service role name"
  value       = module.atlantis.ecs_exec_role_policy_name
}

output "ecs_service_name" {
  description = "ECS Service name"
  value       = module.atlantis.ecs_service_name
}

output "ecs_service_role_arn" {
  description = "ECS Service role ARN"
  value       = module.atlantis.ecs_service_role_arn
}

output "ecs_task_exec_role_name" {
  description = "ECS Task role name"
  value       = module.atlantis.ecs_task_exec_role_name
}

output "ecs_task_exec_role_arn" {
  description = "ECS Task exec role ARN"
  value       = module.atlantis.ecs_task_exec_role_arn
}

output "ecs_task_role_name" {
  description = "ECS Task role name"
  value       = module.atlantis.ecs_task_role_name
}

output "ecs_task_role_arn" {
  description = "ECS Task role ARN"
  value       = module.atlantis.ecs_task_role_arn
}

output "ecs_task_role_id" {
  description = "ECS Task role id"
  value       = module.atlantis.ecs_task_role_id
}

output "ecs_service_security_group_id" {
  description = "Security Group ID of the ECS task"
  value       = module.atlantis.ecs_service_security_group_id
}

output "ecs_task_definition_family" {
  description = "ECS task definition family"
  value       = module.atlantis.ecs_task_definition_family
}

output "ecs_task_definition_revision" {
  description = "ECS task definition revision"
  value       = module.atlantis.ecs_task_definition_revision
}

output "codebuild_project_name" {
  description = "CodeBuild project name"
  value       = module.atlantis.codebuild_project_name
}

output "codebuild_project_id" {
  description = "CodeBuild project ID"
  value       = module.atlantis.codebuild_project_id
}

output "codebuild_role_id" {
  description = "CodeBuild IAM Role ID"
  value       = module.atlantis.codebuild_role_id
}

output "codebuild_role_arn" {
  description = "CodeBuild IAM Role ARN"
  value       = module.atlantis.codebuild_role_arn
}

output "codebuild_cache_bucket_name" {
  description = "CodeBuild cache S3 bucket name"
  value       = module.atlantis.codebuild_cache_bucket_name
}

output "codebuild_cache_bucket_arn" {
  description = "CodeBuild cache S3 bucket ARN"
  value       = module.atlantis.codebuild_cache_bucket_arn
}

output "codebuild_badge_url" {
  description = "The URL of the build badge when badge_enabled is enabled"
  value       = module.atlantis.codebuild_badge_url
}

output "codepipeline_id" {
  description = "CodePipeline ID"
  value       = module.atlantis.codepipeline_id
}

output "codepipeline_arn" {
  description = "CodePipeline ARN"
  value       = module.atlantis.codepipeline_arn
}

output "codepipeline_webhook_id" {
  description = "The CodePipeline webhook's ID"
  value       = module.atlantis.codepipeline_webhook_id
}
...
output "codepipeline_webhook_url" {
  ...
  value       = module.atlantis.codepipeline_webhook_url
  sensitive   = true
}

output "ecs_cloudwatch_autoscaling_scale_up_policy_arn" {
  description = "ARN of the scale up policy"
  value       = module.atlantis.ecs_cloudwatch_autoscaling_scale_up_policy_arn
}

output "ecs_cloudwatch_autoscaling_scale_down_policy_arn" {
  description = "ARN of the scale down policy"
  value       = module.atlantis.ecs_cloudwatch_autoscaling_scale_down_policy_arn
}

output "ecs_alarms_cpu_utilization_high_cloudwatch_metric_alarm_id" {
  value       = module.atlantis.ecs_alarms_cpu_utilization_high_cloudwatch_metric_alarm_id
...
output "ecs_alarms_cpu_utilization_high_cloudwatch_metric_alarm_arn" {
  value       = module.atlantis.ecs_alarms_cpu_utilization_high_cloudwatch_metric_alarm_arn
...
output "ecs_alarms_cpu_utilization_low_cloudwatch_metric_alarm_id" {
  value       = module.atlantis.ecs_alarms_cpu_utilization_low_cloudwatch_metric_alarm_id
...
output "ecs_alarms_cpu_utilization_low_cloudwatch_metric_alarm_arn" {
  value       = module.atlantis.ecs_alarms_cpu_utilization_low_cloudwatch_metric_alarm_arn
...
output "ecs_alarms_memory_utilization_high_cloudwatch_metric_alarm_id" {
  value       = module.atlantis.ecs_alarms_memory_utilization_high_cloudwatch_metric_alarm_id
...
output "ecs_alarms_memory_utilization_high_cloudwatch_metric_alarm_arn" {
  value       = module.atlantis.ecs_alarms_memory_utilization_high_cloudwatch_metric_alarm_arn
...
output "ecs_alarms_memory_utilization_low_cloudwatch_metric_alarm_id" {
  value       = module.atlantis.ecs_alarms_memory_utilization_low_cloudwatch_metric_alarm_id
...
output "ecs_alarms_memory_utilization_low_cloudwatch_metric_alarm_arn" {
  value       = module.atlantis.ecs_alarms_memory_utilization_low_cloudwatch_metric_alarm_arn
...
output "httpcode_target_3xx_count_cloudwatch_metric_alarm_id" {
  value       = module.atlantis.httpcode_target_3xx_count_cloudwatch_metric_alarm_id
...
output "httpcode_target_3xx_count_cloudwatch_metric_alarm_arn" {
  value       = module.atlantis.httpcode_target_3xx_count_cloudwatch_metric_alarm_arn
...
output "httpcode_target_4xx_count_cloudwatch_metric_alarm_id" {
  value       = module.atlantis.httpcode_target_4xx_count_cloudwatch_metric_alarm_id
...
output "httpcode_target_4xx_count_cloudwatch_metric_alarm_arn" {
  value       = module.atlantis.httpcode_target_4xx_count_cloudwatch_metric_alarm_arn
...
output "httpcode_target_5xx_count_cloudwatch_metric_alarm_id" {
  value       = module.atlantis.httpcode_target_5xx_count_cloudwatch_metric_alarm_id
...
output "httpcode_target_5xx_count_cloudwatch_metric_alarm_arn" {
  value       = module.atlantis.httpcode_target_5xx_count_cloudwatch_metric_alarm_arn
...
output "target_response_time_average_cloudwatch_metric_alarm_arn" {
  value       = module.atlantis.target_response_time_average_cloudwatch_metric_alarm_arn
